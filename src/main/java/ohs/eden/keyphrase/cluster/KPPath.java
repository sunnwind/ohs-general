...
public class KPPath {
	...
	public static final String COL_DIR = DATA_DIR + "col/";

	public static final String COL_DB_DIR = COL_DIR + "db/";

	public static final String COL_LINE_DIR = COL_DIR + "line/";

	public static final String COL_LINE_POS_DIR = COL_DIR + "line_pos/";
