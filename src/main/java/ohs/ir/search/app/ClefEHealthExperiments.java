...
public class ClefEHealthExperiments {
	...
	public void test() throws Exception {
		...
		DocumentCollection dc1 = ds1.getDocumentCollection();
		DocumentCollection dc2 = ds2.getDocumentCollection();

		System.out.println(vocab1.toString());
