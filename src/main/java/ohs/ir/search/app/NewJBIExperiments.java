...
public class NewJBIExperiments {
	...
	public static void main(String[] args) throws Exception {
		...
		NewJBIExperiments e = new NewJBIExperiments();
	...
	public static void analyze() throws Exception {
		String[] qFiles = { MIRPath.TREC_CDS_2016_QUERY_FILE, MIRPath.TREC_PM_2017_QUERY_FILE };

		EnglishTokenizer et = new EnglishTokenizer();

		for (String qFile : qFiles) {
			List<BaseQuery> bqs = QueryReader.readQueries(qFile);
			for (BaseQuery bq : bqs) {
				String s1 = bq.getSearchText();
//				System.out.println(s1);
//				System.out.println();

				String s2 = StrUtils.join(" ", et.tokenize(s1));
