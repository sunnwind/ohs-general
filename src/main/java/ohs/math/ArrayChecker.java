...
public class ArrayChecker {
	 ...
	 * [Theorem 1.8]
	 * 
	 * If a set contains more vectors than there are ents in each vector, then
	 * the set is linearly dependent. That is, any set {v_1,...,v_p} in R3 is
	 ...
	 * then the skew symmetric condition is aij = �닋aji. For example, the
