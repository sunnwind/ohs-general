 ...
 * @author ohs
 */
public class BidirectionalRecurrentLayerOld extends RecurrentLayer {
	...
	public BidirectionalRecurrentLayerOld() {

	}

	public BidirectionalRecurrentLayerOld(RecurrentLayer fwd, RecurrentLayer bwd) {
		super();
		this.fwd = fwd;
		this.bwd = bwd;
	...
	public BidirectionalRecurrentLayerOld(Type type, int input_size, int hidden_size, int shift_size, int window_size,
			Nonlinearity non) {
		if (type == Type.RNN) {
	...
	public RecurrentLayer copy() {
		return new BidirectionalRecurrentLayerOld((RecurrentLayer) fwd.copy(), (RecurrentLayer) bwd.copy());
	}
