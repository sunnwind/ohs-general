...
public class ConcatenationLayerOld extends Layer {
	...
	public ConcatenationLayerOld() {

	}

	public ConcatenationLayerOld(int feat_size, Map<Integer, Layer> L) {
	...
	public ConcatenationLayerOld(ObjectInputStream ois) throws Exception {
		readObject(ois);
	}
	...
	public ConcatenationLayerOld copy() {
		...
		ConcatenationLayerOld l = new ConcatenationLayerOld(feat_size, C);
		return l;
	}
	...
	public Map<Integer, Layer> getInnerLayers() {
		return L;
	}
