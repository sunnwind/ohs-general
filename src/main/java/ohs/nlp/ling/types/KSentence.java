...
public class KSentence extends ArrayList<MultiToken> {

	public static final String DELIM_SENT = " __ ";

	public static KSentence newSentence(String s) {
		String[] ps = s.split(" __ ");
		KSentence ret = new KSentence(ps.length);
